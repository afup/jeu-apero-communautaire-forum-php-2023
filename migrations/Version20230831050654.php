...
final class Version20230831050654 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE flash (id INT AUTO_INCREMENT NOT NULL, flasher_id INT NOT NULL, flashed_id INT NOT NULL, is_success TINYINT(1) NOT NULL, score INT NOT NULL, flashed_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX IDX_AFCE5F03A9A6055D (flasher_id), INDEX IDX_AFCE5F03DCD40D1E (flashed_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
